const palettes: Record<string, { className: string; dot: string }> = {
  ...
  'Con movimiento': { className: 'border-emerald-200 bg-emerald-50 text-emerald-700', dot: 'bg-emerald-500' },
  ...
  'Sin movimiento': { className: 'border-blue-200 bg-blue-50 text-blue-700', dot: 'bg-blue-500' },
  ...
  'En proceso de inicio de actividades': { className: 'border-amber-200 bg-amber-50 text-amber-800', dot: 'bg-amber-500' },
  ...
  'Término de giro': { className: 'border-slate-300 bg-slate-100 text-slate-600', dot: 'bg-slate-400' },
}
