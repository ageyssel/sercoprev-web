...
const faqs = [
  ...
  ['¿Cómo recibo mis documentos e informes?', 'Los clientes cuentan con un portal privado para revisar solicitudes, antecedentes financieros, remuneraciones y documentos publicados por SERCOPREV.'],
      ...
      <main>
        ...
        <section className="border-b border-slate-200 bg-white px-4 py-7 sm:px-6">
          <div className="mx-auto grid max-w-7xl grid-cols-2 gap-5 lg:grid-cols-4">
            <TrustItem value="40+" label="años de experiencia" />
        ...
        <section className="px-4 py-24 sm:px-6" id="metodo">
          <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
            <div>
              <SectionIntro eyebrow="Método de trabajo" title="Información ordenada, responsabilidades claras y seguimiento mensual" description="No se trata solo de presentar formularios. El servicio debe permitir saber qué está listo, qué falta y qué decisión requiere la empresa, mientras SERCOPREV mantiene internamente el control de plazos y obligaciones." align="left" />
            ...
            <ol className="grid gap-4 sm:grid-cols-2">
              ...
              <ProcessCard number="04" title="Control y asesoría" description="Entregamos información y acompañamiento para decidir, manteniendo el control operativo en manos de SERCOPREV." />
            </ol>
          </div>
        </section>
        ...
        <section className="overflow-hidden bg-[#eaf1f5] px-4 py-24 sm:px-6" id="portal">
          <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
            ...
            <div className="order-1 lg:order-2">
              <SectionIntro eyebrow="Portal de clientes" title="Su información contable disponible, organizada y protegida" description="El portal SERCOPREV reúne solicitudes, antecedentes financieros, remuneraciones y documentos de cada empresa en un espacio privado, sin exponer el calendario operativo interno del estudio." align="left" />
              <ul className="mt-8 grid gap-4 sm:grid-cols-2">
                {[
                  ['Solicitudes', 'Antecedentes requeridos y estado de recepción.'],
                  ['Documentos', 'Archivos tributarios, laborales y legales.'],
                  ['Información financiera', 'Registros e importes organizados por periodo.'],
                  ['Remuneraciones', 'Liquidaciones y antecedentes laborales publicados.'],
                ].map(([title, text]) => (
        ...
        <section className="px-4 py-24 sm:px-6">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-12 grid gap-5 md:grid-cols-3">
              <Commitment icon="tasks" title="Seguimiento ordenado" description="Solicitudes y estados organizados para que el cliente conozca qué información debe entregar sin trasladarle la presión del calendario operativo interno." />
...
function PortalPreview() { return <div className="relative mx-auto w-full max-w-xl rounded-[2rem] border border-white/10 bg-white/5 p-3 shadow-2xl shadow-black/25 backdrop-blur"><div className="rounded-[1.5rem] bg-[#f5f8fa] p-4 text-[#17324a] sm:p-6"><div className="flex items-center justify-between border-b border-slate-200 pb-4"><div><p className="text-xs font-black uppercase tracking-[0.16em] text-slate-400">Portal SERCOPREV</p><p className="mt-1 font-black">Resumen de la empresa</p></div><span className="rounded-full bg-emerald-100 px-3 py-1 text-xs font-black text-emerald-700">Información disponible</span></div><div className="mt-5 grid grid-cols-3 gap-3"><MiniMetric label="Solicitudes" value="1" /><MiniMetric label="Documentos" value="18" /><MiniMetric label="Consultas" value="0" /></div><div className="mt-5 rounded-2xl border border-slate-200 bg-white p-4"><div className="flex items-center justify-between"><p className="text-sm font-black">Actividad reciente</p><AppIcon name="document" className="h-4 w-4 text-[#134b78]" /></div><div className="mt-4 space-y-3"><PreviewRow title="Informe mensual" meta="Documento disponible" tone="green" /><PreviewRow title="Antecedentes del periodo" meta="Solicitud recibida" tone="blue" /><PreviewRow title="Liquidaciones" meta="Información publicada" tone="green" /></div></div></div></div> }
function ClientPortalPreview() { return <div className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-2xl shadow-[#0f2438]/10 sm:p-6"><div className="flex items-center justify-between"><div><p className="text-xs font-black uppercase tracking-[0.16em] text-slate-400">Mi empresa</p><p className="mt-1 text-lg font-black text-[#0f2438]">Panel mensual</p></div><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#0f2438] text-[#e3bf63]"><AppIcon name="building" className="h-5 w-5" /></span></div><div className="mt-5 grid gap-3 sm:grid-cols-2"><PreviewPanel icon="upload" title="Solicitudes" value="Antecedentes requeridos" /><PreviewPanel icon="folder" title="Documentos" value="Últimos archivos publicados" /><PreviewPanel icon="money" title="Resumen financiero" value="Movimientos del periodo" /><PreviewPanel icon="briefcase" title="Remuneraciones" value="Liquidaciones publicadas" /></div></div> }
