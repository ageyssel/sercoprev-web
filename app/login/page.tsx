      ...
      <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-2xl shadow-[#0f2438]/10 lg:grid-cols-[.95fr_1.05fr]">
        ...
        <section className="flex items-center justify-center p-6 sm:p-10 lg:p-14">
          <div className="w-full max-w-md">
            ...
            <div className="mt-8"><p className="text-xs font-black uppercase tracking-[0.18em] text-[#a47b24]">Acceso seguro</p><h2 className="mt-3 text-3xl font-black tracking-tight text-[#0f2438]">Ingrese a su portal</h2><p className="mt-2 text-sm leading-6 text-slate-500">Clientes: utilice el RUT de su empresa. Personal SERCOPREV: utilice su correo registrado.</p></div>

            <form action={login} className="mt-8 grid gap-5">
              <label className="grid gap-2 text-sm font-bold text-slate-700">Correo o RUT<div className="relative"><AppIcon name="users" className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" /><input name="identifier" type="text" required autoComplete="username" placeholder="76.123.456-7 o nombre@sercoprev.cl" className="h-12 w-full rounded-xl border border-slate-300 bg-white pl-10 pr-3 text-sm font-medium text-[#17324a] outline-none focus:border-[#134b78] focus:ring-4 focus:ring-[#134b78]/10" /></div></label>
